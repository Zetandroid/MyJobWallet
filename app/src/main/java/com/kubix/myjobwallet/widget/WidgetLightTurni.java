...
public class WidgetLightTurni extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < appWidgetIds.length; i++) {
            ...
            RemoteViews views1 = new RemoteViews(context.getPackageName(), R.layout.widget_turni_light);
            RemoteViews views2 = new RemoteViews(context.getPackageName(), R.layout.widget_turni_light);

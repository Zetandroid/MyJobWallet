...
public class WidgetDark extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < appWidgetIds.length; i++) {
            ...
            RemoteViews views1 = new RemoteViews(context.getPackageName(), R.layout.widget_dark);
            RemoteViews views2 = new RemoteViews(context.getPackageName(), R.layout.widget_dark);
            RemoteViews views3 = new RemoteViews(context.getPackageName(), R.layout.widget_dark);
            RemoteViews views4 = new RemoteViews(context.getPackageName(), R.layout.widget_dark);

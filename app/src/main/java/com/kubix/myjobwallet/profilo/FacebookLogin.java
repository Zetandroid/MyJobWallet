...
public class FacebookLogin extends Activity {
    ...
    private FacebookLogin mContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_debug = (TextView) findViewById(R.id.txtName);
                ...
                GraphRequest request = GraphRequest.newMeRequest(loginResult.getAccessToken(), new GraphRequest.GraphJSONObjectCallback() {
                    ...
                    public void onCompleted(JSONObject json, GraphResponse response) {
                        if (response.getError() != null) {
                            ...
                            try {
                                Glide.with(mContext).load("https://graph.facebook.com/"+json.getString("id")+"/picture?type=normal").into((ImageView) findViewById(R.id.imgProfilePic));
    ...
    private void show_facebook_keyhash() {
        try {
            PackageInfo info = getPackageManager().getPackageInfo("MyJobWallet", PackageManager.GET_SIGNATURES);

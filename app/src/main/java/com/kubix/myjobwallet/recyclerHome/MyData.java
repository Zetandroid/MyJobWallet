...
public class MyData {
    ...
    public static Integer[] drawableArray = {R.drawable.ic_home_memo, R.drawable.ic_home_memo, R.drawable.ic_home_memo,
            R.drawable.ic_home_memo, R.drawable.ic_home_memo, R.drawable.ic_home_memo, R.drawable.ic_home_memo,
            R.drawable.ic_home_memo, R.drawable.ic_home_memo, R.drawable.ic_home_memo, R.drawable.ic_home_memo};
